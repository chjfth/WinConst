#ifndef CHHI__WinNT_h_20260223_
#define CHHI__WinNT_h_20260223_
...
//
#if defined(WinNT_IMPL) || (defined CHHI_ALL_IMPL && !defined CHHI_ALL_IMPL_HIDE_WinNT) // [IMPL] begin
// [IMPL] //
// [IMPL] //
...
{
	ITC_NAMEPAIR(SECURITY_MANDATORY_UNTRUSTED_RID), //            (0x00000000L)
	ITC_NAMEPAIR(SECURITY_MANDATORY_LOW_RID), //                  (0x00001000L)
	ITC_NAMEPAIR(SECURITY_MANDATORY_MEDIUM_RID), //               (0x00002000L)
	ITC_NAMEPAIR(SECURITY_MANDATORY_MEDIUM_PLUS_RID), //          (SECURITY_MANDATORY_MEDIUM_RID + 0x100)
	ITC_NAMEPAIR(SECURITY_MANDATORY_HIGH_RID), //                 (0x00003000L)
...
{
//	ITC_NAMEPAIR(TOKEN_MANDATORY_POLICY_OFF), //             0x0
