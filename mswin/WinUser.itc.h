#ifndef CHHI__WinUser_h_20260223_
#define CHHI__WinUser_h_20260223_
...
//
#if defined(WinUser_IMPL) || (defined CHHI_ALL_IMPL && !defined CHHI_ALL_IMPL_HIDE_WinUser) // [IMPL] begin
// [IMPL] //
// [IMPL] //
...
ITC_MAKE_OBJECT(WM_xxx, _e2v_WM_xxx, ITCF_HEX1B)
...
ITC_MAKE_OBJECT(VK_xxx, _e2v_VK_xxx, ITCF_HEX1B)
...
ITC_MAKE_OBJECT(LLKHF_xxx, _b2v_LLKHF_xxx, ITCF_HEX1B)

ITC_MAKE_OBJECT(WS_xxx_toplevel, _b2v_WS_xxx_toplevel, ITCF_HEX4B)

ITC_MAKE_OBJECT(WS_xxx_childwnd, _b2v_WS_xxx_childwnd, ITCF_HEX4B)

ITC_MAKE_OBJECT(WS_EX_xxx, _b2v_WS_EX_xxx, ITCF_HEX4B)
...
ITC_MAKE_OBJECT(WS_xxx_ListBox,
	ITCF_HEX4B,
...
ITC_MAKE_OBJECT(WS_xxx_ComboBox,
	ITCF_HEX4B, 
...
ITC_MAKE_OBJECT(CBN_xxx_ComboBox, _e2v_CBN_xxx_ComboBox, ITCF_SINT)
...
ITC_MAKE_OBJECT(HTxxx_HitTest, _e2v_HTxxx_HitTest, ITCF_SINT)
...
ITC_MAKE_OBJECT(MK_xxx_mouse, _b2v_MK_xxx_mouse, ITCF_HEX2B)
...
ITC_MAKE_OBJECT(DT_xxx_DrawText, _b2v_DT_xxx_DrawText, ITCF_HEX2B)
...
ITC_MAKE_OBJECT(WinstationRights, 
	ITCF_HEX1B,
...
ITC_MAKE_OBJECT(EM_xxx, _e2v_WM_xxx, _e2v_EM_xxx, ITCF_HEX2B)
...
ITC_MAKE_OBJECT(BM_xxx, _e2v_WM_xxx, _e2v_BM_xxx, ITCF_HEX2B)
...
#endif // CHHI__WinUser_h_20260223_
